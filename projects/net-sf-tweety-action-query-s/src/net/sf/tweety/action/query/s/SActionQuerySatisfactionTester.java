package net.sf.tweety.action.query.s;
...
import net.sf.tweety.action.query.s.syntax.AlwaysQuery;
import net.sf.tweety.action.query.s.syntax.HoldsQuery;
import net.sf.tweety.action.query.s.syntax.NecessarilyQuery;
import net.sf.tweety.action.query.s.syntax.QueryProposition;
import net.sf.tweety.action.query.s.syntax.SActionQuery;
...
import net.sf.tweety.logicprogramming.asp.AspException;
  ...
  implements ActionQuerySatisfactionTester
{
  ...
  {
    String result = "";
    if ( queryPart instanceof net.sf.tweety.logics.propositionallogic.syntax.Negation ) {
      net.sf.tweety.logics.propositionallogic.syntax.Negation neg =
        (net.sf.tweety.logics.propositionallogic.syntax.Negation) queryPart;
      result += removeIllegalCharacters( neg.toString() );
      result += "(S) :- not ";
      result += removeIllegalCharacters( neg.getFormula().toString() );
      result += "(S), state(S).\n";
    }
    else if ( queryPart instanceof net.sf.tweety.logics.propositionallogic.syntax.Conjunction ) {
      net.sf.tweety.logics.propositionallogic.syntax.Conjunction conj =
        (net.sf.tweety.logics.propositionallogic.syntax.Conjunction) queryPart;
      result += removeIllegalCharacters( conj.toString() );
      result += "(S) :- ";
    ...
    else if ( queryPart instanceof net.sf.tweety.logics.propositionallogic.syntax.Disjunction ) {
      net.sf.tweety.logics.propositionallogic.syntax.Disjunction disj =
        (net.sf.tweety.logics.propositionallogic.syntax.Disjunction) queryPart;
    ...
    PropositionalFormula formula )
  {
    ...
    if ( formula instanceof net.sf.tweety.logics.propositionallogic.syntax.AssociativeFormula ) {
      ...
      net.sf.tweety.logics.propositionallogic.syntax.Negation neg =
        (net.sf.tweety.logics.propositionallogic.syntax.Negation) formula;
