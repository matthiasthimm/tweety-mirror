...
public class AlchemyMlnReasoner extends AbstractMlnReasoner {
	...
	public double doQuery(FolFormula query) {
		...
		try{
            ...
            processCommandsList.add("-bp");
            processCommandsList.add("true");
            processCommandsList.add("-convThresh");
            processCommandsList.add("1e-6");
            processCommandsList.add("-convIterations");
            processCommandsList.add("40");
