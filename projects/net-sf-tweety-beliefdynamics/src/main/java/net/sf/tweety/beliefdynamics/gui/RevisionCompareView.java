...
public class RevisionCompareView extends JPanel implements PropertyChangeListener {
	...
	/**
	 * Helper method: Creates the belief base control panel, there one can change the ordering
	 * of the belief bases for the revision and add or remove belief bases. It is at the bottom
	 * of this view.
	 */
	...
	/**
	 * Helper method: Creates the controls to show the comparison between the two selected revision methods
	...
	/**
	 * Helper method: Creates the control bar at the top of this view which allows the
	...
	/**
	 * Helper method. Updates the text field representing all the loaded belief bases in the
	...
	/**
	 * Helper method: Runs a revision using the credibility revision operator interface. This means an ordered list
	 ...
	 * @todo Kill warnings, not easy cause '?' does not works with revise method(Collection<T>, T)
	 */
	@SuppressWarnings("unchecked")
	...
	/**
	 * Helper method: Runs a revision of using multiple belief bases with the MultipleBaseRevisionOperator. It simulates
	 ...
	 * formula. It simulates the revision of two belief bases by revising the formulas of the second belief base
	 * one after another.
	 * @param op	The operator used to perform the revision
	 * @return		A map of steps of the revision process to the belief bases.
	 * @todo Kill warnings, not easy cause '?' does not works with revise method(Collection<T>, T)
