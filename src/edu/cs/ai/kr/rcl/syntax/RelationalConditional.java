package edu.cs.ai.kr.rcl.syntax;

import java.util.*;

import edu.cs.ai.kr.*;
import edu.cs.ai.kr.fol.lang.*;
 ...
 * quantifiers and without functions (@see edu.cs.ai.kr.fol.lang.FolLanguageNoQuantifiersNoFunctions)
 * 
...
public class RelationalConditional extends RelationalFormula implements Rule{
	...
	/* (non-Javadoc)
	 * @see edu.cs.ai.kr.fol.syntax.RelationalFormula#containsQuantifier()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see edu.cs.ai.kr.fol.syntax.RelationalFormula#getAtoms()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see edu.cs.ai.kr.fol.syntax.RelationalFormula#getPredicates()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see edu.cs.ai.kr.fol.syntax.RelationalFormula#getUnboundVariables()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see edu.cs.ai.kr.fol.syntax.RelationalFormula#isClosed()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see edu.cs.ai.kr.fol.syntax.RelationalFormula#isClosed(java.util.Set)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see edu.cs.ai.kr.fol.syntax.RelationalFormula#isWellBound()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see edu.cs.ai.kr.fol.syntax.RelationalFormula#isWellBound(java.util.Set)
	 */
	@Override
