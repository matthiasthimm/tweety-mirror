...
public class FunctionalTerm extends Term {
	...
	/* (non-Javadoc)
	 * @see edu.cs.ai.kr.fol.syntax.Term#substitute(edu.cs.ai.kr.fol.syntax.Term, edu.cs.ai.kr.fol.syntax.Term)
	 */
	...
	/* (non-Javadoc)
	 * @see edu.cs.ai.kr.fol.syntax.Term#getConstants()
	 */
	...
	/* (non-Javadoc)
	 * @see edu.cs.ai.kr.fol.syntax.Term#getVariables()
	 */
	...
	/* (non-Javadoc)
	 * @see edu.cs.ai.kr.fol.syntax.Term#getFunctors()
	 */
	...
	/* (non-Javadoc)
	 * @see edu.cs.ai.kr.fol.syntax.Term#toString()
	 */
