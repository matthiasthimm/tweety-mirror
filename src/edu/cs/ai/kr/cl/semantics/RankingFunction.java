package edu.cs.ai.kr.cl.semantics;

import java.util.*;

import edu.cs.ai.kr.*;
import edu.cs.ai.kr.cl.*;
...
public class RankingFunction extends Interpretation {
	...
	/* (non-Javadoc)
	 * @see edu.cs.ai.logic.Interpretation#satisfies(edu.cs.ai.logic.Formula)
	 */
	...
	/* (non-Javadoc)
	 * @see edu.cs.ai.kr.Interpretation#satisfies(edu.cs.ai.logic.KnowledgeBase)
	 */
