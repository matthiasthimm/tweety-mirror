...
import qoca.*;
import edu.cs.ai.math.equation.Equation;
import edu.cs.ai.math.equation.Inequation;
import edu.cs.ai.math.equation.Statement;
import edu.cs.ai.math.opt.ConstraintSatisfactionProblem;
import edu.cs.ai.math.opt.ProblemInconsistentException;
import edu.cs.ai.math.opt.Solver;
import edu.cs.ai.math.term.Constant;
import edu.cs.ai.math.term.FloatConstant;
import edu.cs.ai.math.term.IntegerConstant;
import edu.cs.ai.math.term.Product;
import edu.cs.ai.math.term.Sum;
