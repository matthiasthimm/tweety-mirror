...
import edu.cs.ai.math.opt.solver.ApacheCommonsSimplex;
import edu.cs.ai.math.term.FloatConstant;
import edu.cs.ai.math.term.FloatVariable;
...
public class NewtonRootFinder extends RootFinder {
	...
	/* (non-Javadoc)
	 * @see edu.cs.ai.math.opt.RootFinder#randomRoot(java.util.Collection)
	 */
	@Override
