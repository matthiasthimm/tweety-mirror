...
public class OptimizationProblem extends ConstraintSatisfactionProblem {
	...
	/* (non-Javadoc)
	 * @see edu.cs.ai.math.opt.ConstraintSatisfactionProblem#isLinear()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see edu.cs.ai.math.constraints.ConstraintSatisfactionProblem#isMinimumFree()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see edu.cs.ai.math.constraints.ConstraintSatisfactionProblem#resolveMinimums()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see edu.cs.ai.math.constraints.ConstraintSatisfactionProblem#getVariables()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see edu.cs.ai.math.constraints.ConstraintSatisfactionProblem#getMinimums()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see edu.cs.ai.math.constraints.ConstraintSatisfactionProblem#collapseAssociativeOperations()
	 */
	@Override
